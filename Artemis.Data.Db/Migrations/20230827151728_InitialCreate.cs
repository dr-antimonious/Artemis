        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalNames = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ShooterId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StartTimestampId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EndTimestampId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_EndTimestampId",
                table: "Matches",
                column: "EndTimestampId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_ShooterId",
                table: "Matches",
                column: "ShooterId");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_StartTimestampId",
                table: "Matches",
